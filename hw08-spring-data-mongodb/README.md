...
Для работы приложения необходим запущенный экземпляр MongoDB.
На машине должен быть установлен docker (docker-compose в новых версиях поставляется вместе с docker).
Чтобы запустить MongoDB нужно выполнить команду:
